<template>
  <div class="flex flex-col md:flex-row w-full overflow-y-auto">
    <div class="w-full md:w-[40%] h-full overflow-y-auto">
    ...
    <div class="w-full md:flex-1 h-full flex flex-col overflow-hidden bg-white rounded-lg text-center border shadow-md">
      ...
      <div class="flex-1 md:overflow-hidden overflow-y-auto">
        <SurveyChat v-if="currentTab === 'survey' && selectedSurvey"
          :survey="selectedSurvey" @updateHasConclusion="updateHasConclusion" />
